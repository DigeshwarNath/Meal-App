// This make a favourites meal array if it is not exist in local storage
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// this fetch meals from api and return it
...
// this show's all meals card in main according to search input value
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-1 d-block">000</span>
                            <div class="mb-4 lead">
...
//This shows full meal details in main section
...
// This shows all favourite meals in favourites body
...
//This adds and remove meals to your favourite list
function addRemoveToFavList(id) {
    ...
    if (contain) {
        ...
        arr.push(id);
        alert("Yeh! your Meal will added to your favourities lst");
    }
